...
uploaded_file1 = st.sidebar.file_uploader("カレンダー", type=['csv'])
  
uploaded_file2 = st.sidebar.file_uploader("スタッフ", type=['csv'])

if uploaded_file1 is not None:
    calendar_df = pd.read_csv(uploaded_file1)
    
if uploaded_file2 is not None:
    staff_df = pd.read_csv(uploaded_file2)
...
with tab3:
    ...
    if uploaded_file1 is not None and uploaded_file2 is not None:
        ...
        if optimize_button:
            ...
            shift_sum_slot = shift_sch.sch_df.sum(axis=0)
